...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // pazari
        if ($pathinfo === '/pazari') {
            return array (  '_controller' => 'Acme\\UserBundle\\Controller\\PazariController::indexAction',  '_route' => 'pazari',);
        }

        // sell
        if ($pathinfo === '/sell') {
            return array (  '_controller' => 'Acme\\UserBundle\\Controller\\SellController::indexAction',  '_route' => 'sell',);
        }

        // sell_add
        if ($pathinfo === '/sell_add') {
            return array (  '_controller' => 'Acme\\UserBundle\\Controller\\SellController::indexAction',  '_route' => 'sell_add',);
        }
        ...
        if (0 === strpos($pathinfo, '/profile')) {
            ...
            if (rtrim($pathinfo, '/') === '/profile') {
                ...
                return array (  '_controller' => 'Acme\\UserBundle\\Controller\\ProfileController::showAction',  '_route' => 'fos_user_profile_show',);
            }
            not_fos_user_profile_show:

            // fos_user_profile_edit
            if ($pathinfo === '/profile/edit') {
                return array (  '_controller' => 'Acme\\UserBundle\\Controller\\ProfileController::editAction',  '_route' => 'fos_user_profile_edit',);
            }
        ...
        if (0 === strpos($pathinfo, '/register')) {
            ...
            if (0 === strpos($pathinfo, '/register/confirm') && preg_match('#^/register/confirm/(?P<token>[^/]+?)$#xs', $pathinfo, $matches)) {
                ...
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Acme\\UserBundle\\Controller\\RegistrationController::confirmAction',)), array('_route' => 'fos_user_registration_confirm'));
            }
